...
api.post('/usuarios/agregarMaestros',md_autenticacion.Auth, usuariosController.RegistrarMaestros);
...
api.get('/usuariosPDF', (req, res) => {
    const stream = res.writeHead(200, {
        'Content-Type': 'application/pdf',
        'Content-Disposition': 'attachment; filename;filname=usuarios.pdf',
    });

    usuariosController.generarPDF(
